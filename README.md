...
* `semanticMerging` - set to true to enable semantic merging based on BEM-like logic (default is false as it's highly likely this will break your stylesheets - **use with caution**!)
